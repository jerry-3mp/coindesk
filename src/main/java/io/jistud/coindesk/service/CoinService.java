...
public interface CoinService {
  ...
  /**
   * Updates an existing coin by its ID with optional internationalized names. Existing i18n entries
   * not included in the update request will be preserved (merge approach).
   *
